...
import observers.MovementObserver;
import observers.AccidentObserver;
...
public abstract class Vehicle {
    ...
    protected List<MovementObserver> movementObservers = new ArrayList<>();
    protected List<AccidentObserver> accidentObservers = new ArrayList<>();
    ...
    public void enterNextNode() {
        ...
        notifyMoved(previousNode, currentNode);
    }
    ...
    public void addMovementObserver(MovementObserver o) { 
        if (!movementObservers.contains(o)) 
            movementObservers.add(o);
    }
    public void addAccidentObserver(AccidentObserver o) { 
        if (!accidentObservers.contains(o)) 
            accidentObservers.add(o);
    }

    protected void notifyMoved(Node from, Node to) {
        for (MovementObserver o : movementObservers) 
            o.onVehicleMoved(this, from, to);
    }
    protected void notifyCollision(Lane location) {
        for (AccidentObserver o : accidentObservers) 
            o.onCollisionEvent(this, location);
    }
