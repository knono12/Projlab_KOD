package model.environment.lane;

import java.util.ArrayList;
import java.util.List;

import model.environment.lane.lanestates.ClearState;
import model.environment.lane.lanestates.IcyState;
import model.environment.lane.lanestates.LaneState;
...
import observers.LaneStateObserver;
...
public class Lane {
    ...
    private List<LaneStateObserver> observers = new ArrayList<>();
    ...
    public void addLaneStateObserver(LaneStateObserver o) {
        if (!observers.contains(o)) {
            observers.add(o);
            o.onLaneStateChanged();
        }
    }

    private void notifyLaneStateChanged() {
        for (LaneStateObserver o : observers) {
            o.onLaneStateChanged();
        }
    }
