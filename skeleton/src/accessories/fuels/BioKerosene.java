...
/**
 * A biokerozint reprezentáló osztály, amely a {@link Fuel} osztályból származik.
 * Ezt a fogyóeszközt a sárkányfej használja az utakon lévő hó / jég gyors felolvasztásához.
 */
public class BioKerosene extends Fuel{
     ...
     */
    public BioKerosene(int amount, String name, int price){
        super(amount, name);
        this.price = price;
    }
