 ...
 * Takarítás közben biokerozint ({@link BioKerosene}) fogyaszt. Képes azonnal felolvasztani a jeget és a havat, amivel a sávot ClearState állapotba juttatja.
 */
public class FlamethrowerAttachment extends Attachment{
     ...
     */
    public FlamethrowerAttachment(String name, int price){
        super(name);
        this.price = price;
    }
    ...
    /**
     * Megkísérel biokerozint fogyasztani, és ha sikerül, felolvasztja a havat/jeget.
    ...
    public boolean clean(Lane l){
        ...
        if (bioKerosene.consume() && bioKerosene != null) {
            success = l.melt();
        }
